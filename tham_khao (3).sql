...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2018 at 06:11 PM
...
(2, 'Thạch Kem Chanh Dây', 'Những ly thạch trái cây nhiều màu luôn hấp dẫn thực khách mọi lứa tuổi, hãy tự tay làm những ly thạch kem thơm ngon đẹp mắt để xua tan cái oi bức lúc thời tiết chuyển mùa nhé.        ', 15000, 'Douong2.jpg', 1),
(3, 'Thạch Trái Cam Mát Lạnh ', '    gt nè', 15000, 'Thach_TraiCamMatLanh.jpg', 2),
(4, 'Thạch Sữa Ướp Lạnh ', 'Thạch sữa ướp lạnh là món tráng miệng tuyệt vời cho cả nhà. Vị mát, ngọt và mùi thơm hấp dẫn của hoa trái mùa hè hòa quện trong món thạch sữa này.  ', 15000, 'Thach_SuaUopLanh.jpg', 2),
(5, 'Thạch Sữa Đậu Nành ', 'Chỉ cần bằng cách làm đơn giản, món sữa đậu đã trở thành những cốc thạch hoa quả thơm mát và bổ dưỡng rồi.  ', 15000, 'Thach_SuaDauNanh.jpg', 2),
(7, 'Cocktail Cam 3 Tầng', 'Lạ và hấp dẫn, món uống này sẽ mang lại cho bạn một buổi tối thật thú vị!  ', 35000, 'CockTail_Cam3Tang.jpg', 3),
(9, 'Cocktail Chanh Mojito', 'Cocktail chanh Mojito là loại đồ uống không thể bỏ qua khi nhắc đến đất nước Cu Ba xinh đẹp. Sinh thời, đại văn hào Ernest Hemingway đã rất “mê mẩn” thức uống tuyệt vời này. Có rất nhiều cách để pha chế Mojito như dùng vang trắng, Vodka lúa mới, Rum chauvet… nhưng có lẽ đúng nhất thì vẫn phải là light Rum.  ', 35000, 'CockTail_ChanhMojito.jpg', 3),
(11, 'Cocktail Tình Yêu ', 'Hương thơm tươi mát ngọt ngào làm tinh thần sảng khoái, lượng vitamin dồi dào và màu đỏ quyến rũ là những lý do làm cho trái dâu trở thành sự lựa chọn đầu tiên trong các loại trái cây làm món thức uống cho bữa tiệc tình yêu.  ', 35000, 'CockTail_TinhYeu.jpg', 3),
(22, 'Trà Long Nhãn ', 'Nếu bạn hoặc người thân đang mất ngủ hoặc bị stress thì bát chè long nhãn thơm ngon sẽ là bài thuốc trị bệnh tuyệt vời. Chắc hẳn bạn sẽ nhận được vô số lời khen sau khi chế biến thành công món chè ngon miệng này.', 100000, 'Che_LongNhan.jpg', 3),
(24, 'Chè Đậu Ngự ', 'Món chè đậu ngự vừa có thể giải khát, vừa có tác dụng bồi bổ cơ thể, là một món ăn rất tốt trong mùa hè.   ', 69000, '24.jpg', 1),
(29, 'Kem Dâu Tình Yêu', 'Bạn băn khoăn không biết làm gì cho một nửa của mình trong mùa hè oi bức này. Tại sao không thử tự tay chế biến món kem dâu tình yêu này, chắc chắn người ấy sẽ bất ngờ với ly kem dâu mát lạnh, ngọt ngào như chính tình yêu của bạn. ', 60000, 'Kem_DauTinhYeu.jpg', 3),
(52, ' Nước Nha Đam Mát Lạnh ', 'Cây nha đam hay người ta vẫn gọi là cây lô hội, hoặc như trong các siêu thị lớn thì lại gọi là long tu, được biết đến như một nguyên liệu đặc biệt để sản xuất mỹ phẩm. Nhưng thật ra loại cây này còn có nhiều công dụng hơn thế.  ', 1234, 'Douong52.jpg', 3),
(62, 'Trà Sữa 1', 'giai nhiet', 69000, '62.jpg', 1);
...
(3, 'Bánh Pho Mát Thơm Ngậy', 'Bánh pho mát mềm mượt như kem, dậy mùi thơm, vị beo béo rất hấp dẫn. Cuối tuần ở nhà bạn tranh thủ làm món này cho bọn trẻ nhé.', 70000, '3.jpg', 2),
(4, 'Bánh Sữa Chua Dâu Tây', 'Bánh dâu hình hoa sen xinh xắn cách làm rất dễ, vị trái cây dịu ngọt quyện với lớp sữa chua mát lạnh và vỏ bánh xốp giòn thơm ngon.', 90000, '4.jpg', 2),
(5, 'Pancake Tình Yêu', 'Bữa sáng đơn giản nhưng cho bạn cảm giác thật dễ chịu và hạnh phúc. Hãy thử món bánh pancake vị dưa hấu thơm mát này nhé.', 70000, '5.jpg', 2),
(7, 'Bún Bò Nam Bộ', 'Cùng tên gọi bún bò, song mỗi vùng miền lại có cách chế biến khác nhau. đối với người miền Nam, bún bò Nam Bộ - còn gọi là bún thịt bò xào - vừa giản dị lại tinh tế.', 50000, '7.jpg', 1),
(8, 'Súp Móng Giò', 'Móng giò mùi vị thơm ngon, đem ninh với đậu nành thì giá trị dinh dưỡng càng cao. Đặc biệt món này ăn vào những ngày trời lạnh rất bổ dưỡng, tốt cho sức khỏe.', 60000, '8.jpg', 1),
(9, 'Canh xoài thịt bò', 'gt nè', 80000, '9.jpg', 1),
(11, 'Canh Mướp Đắng Nhồi Thịt Gà', 'Bát canh mướp đắng xanh mướt, thật ngon mắt; viị ngọt, bùi, thanh mát và hơi đăng đắng hòa quyện với nhau.', 19000, '11.jpg', 3),
(12, 'Trứng Hấp Đậu Hũ', 'Món ăn này thích hợp cho mọi lứa tuổi trong gia đình, trứng hấp đậu hũ mềm, hương vị lạ, giàu protein và rất tốt cho hệ tiêu hóa.', 35000, '12.jpg', 3),
(13, 'Bí Ngòi Xào Ngô', 'Quả bí ngòi xào với ngô ngọt tuy là món xào nhưng ăn lại rất thanh mát, thêm mùi thơm hấp dẫn của rau mùi ăn mùa hè rất hợp và không hề ngán.', 45000, '13.jpg', 3),
(15, 'Ếch Xào Lăn', 'Sau khi chế biến, thịt ếch mềm, bạc hà giòn, ngọt là bạn đã thành công. Đây là một món ăn rất thích hợp trong những bữa ăn cải thiện hay sum họp gia đình, nó cũng thích hợp cho những bữa nhậu.', 145000, '15.jpg', 1),
(16, 'Bánh Cam', 'Giới thiệu bánh cam', 10000, '16.jpg', 2),
(17, 'Vịt om sấu', 'gt nè', 100000, '17.jpg', 1),
(19, 'Bánh Chuối Hấp ', 'Giới thiệu bánh chuối hấp', 25000, '19.jpg', 2),
(21, 'Tôm xào hạnh nhân ', 'gt nè', 60000, '21.jpg', 1),
(25, 'Chả cá chiên xù ', 'gt chả cá chiên xù', 45000, '25.jpg', 3),
(26, 'Chả cá bọc trứng cút kho ', 'gt nè', 35000, '26.jpg', 3),
(28, 'Bánh sữa ', 'Những chiếc bánh này dùng để đãi tiệc ngọt hoặc làm món tráng miệng. Bánh có vị ngọt thanh, hình thức rất bắt mắt.', 20000, '28.jpg', 2);
